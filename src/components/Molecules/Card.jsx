...
const Card = ({ backgroundImage, cliente, alt, href }) => {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer">
      ...
      <article id={`card-${cliente}`} className='card relative mx-auto overflow-hidden w-[80vw] lg:w-[210vw] xl:w-[320PX] z-0 h-[240px] lg:h-[210px] rounded-lg border-2 border-slate-800 shadow-lg shadow-slate-600 transition-shadow animate__animated animate__bounceIn duration-1000 animate__slower delay-1000'>
