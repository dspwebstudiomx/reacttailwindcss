...
const Testimonial = ({ key, nombre, empresa, imagen, testimonio, hyperlink }) => {
  return (
    <article key={key} className='border-blue-900 border-2 rounded-xl p-6 flex flex-col gap-5 bg-slate-200 justify-center shadow-2xl animate_animated animate__bounceIn'>
