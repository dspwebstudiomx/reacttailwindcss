...
const Footer = () => {
  return (
    <footer className="w-full text-slate-100 body-font">
      ...
      {/*  Columns Container */}
      <section
        className="container flex flex-col flex-wrap p-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap bg-slate-600">
        ...
        {/* Columns Section */}
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left lg:w-1/3">
      ...
      <section className="bg-slate-950 text-white">
        <div className="container px-5 py-4 mx-auto">
          <p className="text-sm capitalize xl:text-center">© 2024 Todos los derechos reservados </p>
        </div>
      </section>
      {/* Copyright Section */}
