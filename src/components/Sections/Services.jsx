    ...
    <Section id='services' className='bg-slate-300'>
      <Container>
        ...
        {servicios.map((servicio) => {
          return (
            <article key={servicio.id} className='flex flex-col mt-2 gap-32 w-[75%] sm:w-[60%] xl:w-[85%] mx-auto'>
              <div className='flex flex-col sm:flex-row'>
                <div className='flex flex-col gap-6 justify-center'>
                  <h3 className='text-4xl font-semibold'><span className='text-blue-700 dark:text-blue-500 mr-3'>{servicio.id}.</span>{servicio.serviceName}</h3>
