...
const ErroresComunesDisenoWeb = () => {
  return (
    <Article title={'Los Errores Más Comunes en el Diseño Web y Cómo Evitarlos'} id={6} category={'Diseño Web'} author={'Daniel S.'} image={Image} date={'noviembre 21, 2023'} source={'unsplash.com'} imageLink='https://unsplash.com' time='3 min.' slug='diseño-web' keywords={'errores, Diseño Web, errores comunes Diseño Web'} description={'Errores comunes en Diseño Web'} linkHref={'blog/diseño-web/errores-comunes'}>
