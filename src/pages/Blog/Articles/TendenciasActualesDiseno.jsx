...
const TendenciasActualesDiseno = () => {
  return (
    <Article title={'Tendencias Actuales en Diseño Web: ¿Qué Está en Boga?'} id={8} category={'Diseño Web'} author={'Daniel S.'} image={Image} date={'enero 12, 2023'} source={'unsplash.com'} imageLink='https://unsplash.com' time='3 min.' slug={'diseno-web'} description={'Tendencias actuales en el Diseño Web'} keywords={'Diseño Web, Tendencias, Diseño'} linkHref={'blog/diseño-web/tendencias-actuales'}>
