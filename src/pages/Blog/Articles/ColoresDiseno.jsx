...
const ColoresDiseno = () => {
  return (
    <Article title={'¿Cómo elegir la Paleta de Colores perfecta para tu Sitio Web?'} id={4} category={'Diseño Web'} author={'Daniel S.'} image={Image || Placeholder} date={'septiembre 12, 2023'} source={'pexels.com'} imageLink='https://pexels.com' time='2 min.' slug={'diseño-web'} keywords={'colores, sitio web'} description={'Elegir Paleta de Colores para Sitio Web'} linkHref={'blog/diseño-web/paleta-colores'}>
