...
const HerramientasDiseñoWeb = () => {
  return (
    <Article title='Herramientas del Diseño Web imprescindibles para principiantes y procesionales' id={3} category='Herramientas' author='Daniel S.' image={Image || Placeholder} date='agosto 21, 2023' source={'pexels.com'} time='2 min.' slug={'herramientas'}>
