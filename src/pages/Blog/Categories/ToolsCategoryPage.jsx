...
const ToolsCategoryPage = () => {
  ...
  const filterDataCategory = articulosBlog.filter(articulo => articulo.categoria == "Herramientas")
  ...
  return (
    <HelmetProvider>
      <SEOFriendly
        linkHref={'blog/herramientas'}
        title={'Blog | Herramientas | dspwebstudio'}
        description={'Categoría Herramientas - Blog'}
        author={'dspwebstudio'}
        keywords={'herramientas, diseño, diseño web, herramientas web'}
        type={'website'}
        image={image}
      />
      <div id="scrollTop">
        ...
        <main id='blog' className='mt-20 dark:bg-slate-800 bg-slate-300'>
          <Hero image={image} height={'h-[23vh] md:h-[20vh] xl:h-[33vh]'}>
            <h1 className='text-4xl font-semibold'>Herramientas</h1>
          </Hero>
          <Section>
