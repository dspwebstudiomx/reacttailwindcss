...
const PersonalCategoryPage = () => {
  ...
  const filterDataCategory = articulosBlog.filter(articulo => articulo.categoria == "Personal")
  ...
  return (
    <HelmetProvider>
      <SEOFriendly
        linkHref={'blog/personal'}
        title={'Blog | Personal | dspwebstudio'}
        description={'Categoría Personal - Blog'}
        author={'dspwebstudio'}
      ...
      <div id="scrollTop">
        ...
        <main id='blog' className='mt-20 dark:bg-slate-800 bg-slate-300'>
          <Hero image={image} height={'h-[23vh] md:h-[20vh] xl:h-[33vh]'}>
            <h1 className='text-4xl font-semibold'>Personal</h1>
          </Hero>
          <Section>
