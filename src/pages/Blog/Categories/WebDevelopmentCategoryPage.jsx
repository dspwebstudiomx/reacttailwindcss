...
import image from "../../../assets/Images/Blog/Categorias/code-image.webp"
...
const WebDevelopmentCategoryPage = () => {
  ...
  return (
    <HelmetProvider>
      <SEOFriendly
        linkHref={'blog/desarrollo-web'}
        title={'Blog | Desarrollo Web | dspwebstudio'}
        description={'Categoría Desarrollo Web - Blog'}
        author={'dspwebstudio'}
        keywords={'desarrollo, blog, desarrollo web'}
        type={'website'}
        image={image}
      />
      <div id="scrollTop">
